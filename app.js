...
const INITIAL_SCENARIOS = [
  {
    ...
    opening: "刚才误会你了，我道歉。衬衫我赔，或者请你喝一杯——但我不是对谁都这么主动。",
    suggestions: ["衬衫之外，还欠我顿夜宵", "你追出来不只是在担心画吧"],
  ...
  },
  {
    ...
    opening: "你不是陈放？那你刚才怎么答得那么认真。既然都聊到这了，告诉我：那个答案只说给相亲对象听吗？",
    suggestions: ["如果是你，我会答得更认真", "你认错人后怎么没走"],
  ...
  },
  {
    ...
    opening: "搬了六层又被我困在门外，只说谢谢太敷衍。楼顶、两罐酒，要不要把这段倒霉时间过得像约会？",
    suggestions: ["去楼顶，酒要你递给我", "你对谁都这样谢吗"],
  ...
  },
  {
    ...
    opening: "原来便签不是写给我的。书还你，但那句话让我白心动了几秒——这笔账怎么算？",
    suggestions: ["现在写给你也来得及", "我想听你刚才的答案"],
  ...
  },
  {
    ...
    opening: "原来你只是来还卡。抱歉，我误会了……也白期待了一秒。末班车还有四分钟，要我解释吗？",
    suggestions: ["先解释那一秒", "你期待我有什么理由"],
  ...
  },
  {
    ...
    opening: "画先还我，手可以晚点松。那张侧脸一开始不是你——后来是不是，你要听真话吗？",
...
const CHARACTERS = [
  {
    ...
    life: {
      current_goal: "完成城市散步主题小册子的插画样稿", current_problem: "一张夜景构图始终不满意", next_plan: "周末去旧书店找排版参考", recent_events: [],
      recurring_people: ["务实的编辑苏禾", "住在楼下的花店老板阿宁"], habits: ["思考时在纸角画小窗户", "紧张时把袖口拉过指尖"], flaws: ["怕麻烦别人而拖到最后", "容易把拒绝理解成否定自己"], regret: "曾因不敢争取署名而失去一组重要作品", off_duty_events: ["照顾楼下橘猫", "收集旧电影票根", "独自坐末班公交看城市"]
    },
